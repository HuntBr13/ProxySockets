package com.huntbr.proxy;

import com.huntbr.proxy.packet.HandshakePacket;
import com.huntbr.proxy.streams.MinecraftInputStream;
import com.huntbr.proxy.streams.MinecraftOutputStream;
...
public class Connection implements Runnable {
    ...
    public void sendMOTD() {
        try {
            String json = "{\"version\":{\"name\":\"Proxy INC.\",\"protocol\": 5},\"players\":{\"max\":1337,\"online\":0,\"sample\":[{\"name\":\"9gigsofram\",\"id\":\"4566e69f-c907-48ee-8d71-d7ba5aa00d20\"}]},\"description\":{\"text\":\"Failed to connect to requested backend server. Please contact an administartor of the proxy.\"}}";
